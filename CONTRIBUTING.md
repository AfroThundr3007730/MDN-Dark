...
There are a number of ways to get involved with the development of this MDN Dark theme. Even if you've never contributed to an Open Source project before, we're always looking for help identifying missing styles or other issues.
...
* [Download](https://github.com/AfroThundr3007730/MDN-Dark/archive/master.zip), [fork](https://github.com/AfroThundr3007730/MDN-Dark/fork) or clone this repository.
* Use [node.js](http://nodejs.org/) to run `npm install`.
* Make any changes to the `mdn-dark.user.css` file and save.
